			...
			<div class="col-lg-9">
				<div class=row>
					<div class="col-md-6 pb-4">
						<div class="d-flex">
							<select class="form-cntrol" id="sortingOption" style="width: 50%">
								<!-- 정렬방법 -->
								 <option value="default">기본 순 정렬</option>
								 <option value="nameAscending">제품명 오름차순 정렬</option>
								 <option value="nameDescending">제품명 내림차순 정렬</option>
								 <option value="priceHighToLow">금액 높은 순 정렬</option>
								 <option value="priceLowToHigh">금액 낮은 순 정렬</option>
							</select>
						</div>
					</div>
				</div>
